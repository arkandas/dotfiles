# Generated by Powerlevel10k configuration wizard on 2021-12-15 at 00:22 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%F{123} \uf827%F{121} %m%f'
  # Icons
  # f6e4 -> duck
  # fb8a -> skull
  # f8d1 -> owl
  ...
  typeset -g POWERLEVEL9K_GO_VERSION_BACKGROUND=119
