# Generated by Powerlevel10k configuration wizard on 2024-02-06 at 00:07 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%K{015}%F{160} \uf157 %F{015}%k\ue0b0%f'
  ...
  typeset -g POWERLEVEL9K_DISK_USAGE_NORMAL_FOREGROUND=234
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{81}%n%F{203} \ue231 %F{48} %m%f'
